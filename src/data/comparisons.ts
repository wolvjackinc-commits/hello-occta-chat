...
export const comparisons: Comparison[] = [
  {
    ...
    metaDescription: "Compare OCCTA vs BT broadband. Cheaper headline prices, no mid-contract price rises, and a choice of Price Lock 24 or Flex 30 rolling monthly where eligible.",
  ...
  },
  {
    ...
    metaDescription: "Compare OCCTA vs Sky broadband. Cheaper headline prices, no hidden fees, and Flex 30 rolling monthly where eligible. See how the two compare.",
  ...
  },
  {
    ...
    metaDescription: "Compare OCCTA vs Virgin Media broadband. See how OCCTA compares on price, coverage and contract terms on the Openreach network.",
    ...
    summary: "Virgin Media offers fast speeds on its own cable network, but coverage is limited and contracts are long. OCCTA covers more of the UK via Openreach, with lower prices and Flex 30 rolling monthly where eligible.",
    faqs: [
  ...
  },
  {
    ...
    metaDescription: "Compare OCCTA vs TalkTalk broadband. Both are budget-friendly, but OCCTA has no mid-contract price rises and Flex 30 rolling monthly where eligible.",
  ...
  },
  {
    ...
    metaDescription: "Compare OCCTA vs Plusnet broadband. Both offer value broadband, but OCCTA has no hidden price rises and flexible term options. Full comparison inside.",
    ...
    intro: "Plusnet (owned by BT) markets itself as friendly, good-value broadband. OCCTA takes that further with no mid-contract price rises and a choice of Price Lock 24 or Flex 30 where eligible.",
    points: [
