...
export const faqs = [
  ...
  { question: "Can I use my own router?", answer: "Yes — most PPPoE-capable routers work. Follow our step-by-step guide at /help/own-router-setup. You'll need the PPPoE username and password from your OCCTA welcome email.", category: "services" },
  { question: "How do I set up my own router with OCCTA?", answer: "Use the PPPoE username and password from your OCCTA welcome / go-live email. Full instructions, brand-specific admin URLs and troubleshooting are at /help/own-router-setup.", category: "services" },
  { question: "What is PPPoE?", answer: "PPPoE is the login method your router uses to authenticate with OCCTA broadband. Enter the OCCTA-supplied username and password into your router's PPPoE / WAN settings.", category: "services" },
  ...
  { question: "How do I make a formal complaint?", answer: "Visit our Complaints page to submit a formal complaint. We follow Ofcom guidelines and aim to resolve issues within 6 weeks (or sooner if we issue a deadlock letter). Still need help? Our AI assistant or support ticket system can assist you further.", category: "complaints" },
];
