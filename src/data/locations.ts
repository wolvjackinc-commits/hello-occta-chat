...
export const locations: Location[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is included with Liverpool broadband?", answer: "Every OCCTA plan includes unlimited data, a Wi-Fi router, Setup from £0 where available, and no contract. You can also add Digital Home Phone from \u00A34.99/mo." },
    ],
  },
  {
    slug: "sheffield",
