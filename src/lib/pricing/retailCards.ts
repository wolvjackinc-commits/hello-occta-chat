...
export const landlineRetailCard: RetailCardDef = {
  ...
  features: [
    ...
    'Caller display',
    'Free voicemail',
    'No contracts — 30-day rolling options available where eligible',
...
export const simRetailCards: RetailCardDef[] = [
  {
    ...
    publicFeatures: ['5GB 5G data', 'Unlimited UK calls', 'Unlimited texts', 'EU roaming included', 'No contracts — 30-day rolling options available where eligible', 'Free SIM delivery'],
    publicDisclaimer: '',
  },
  {
    id: 'sim-essential',
    ...
    publicFeatures: ['15GB 5G data', 'Unlimited UK calls', 'Unlimited texts', 'EU roaming included', 'No contracts — 30-day rolling options available where eligible', 'Data rollover'],
    publicDisclaimer: '',
  },
  {
    id: 'sim-plus',
    ...
    publicFeatures: ['50GB 5G data', 'Unlimited UK calls', 'Unlimited texts', '30GB EU roaming', 'No contracts — 30-day rolling options available where eligible', 'Data rollover'],
    publicDisclaimer: '',
  },
  {
    id: 'sim-unlimited',
    ...
    publicFeatures: ['Unlimited 5G data', 'Unlimited UK calls', 'Unlimited texts', '50GB EU roaming', 'No contracts — 30-day rolling options available where eligible', 'Free intl calls (50 countries)'],
    publicDisclaimer: '',
  },
];
