...
export const AdminBilling = () => {
  ...
  const { data, refetch } = useQuery({
    ...
    queryFn: async () => {
      const [invoices, receipts, adjustments, credits] = await Promise.all([
        supabase
          .from("invoices")
          .select("id, invoice_number, status, totals, issue_date, user_id")
  ...
  const handleCreateInvoice = async () => {
    ...
    setOpen(false);
    setInvoiceForm({ userId: "", invoiceNumber: "", description: "", amount: "" });
    refetch();
  };
