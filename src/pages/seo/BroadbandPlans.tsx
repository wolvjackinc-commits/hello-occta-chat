  ...
  return (
    <>
      <SeoContentLayout
        ...
        metaDescription="Compare OCCTA broadband plans: Flex 30 or Price Lock 24, full fibre up to 900Mbps, free router, UK-based support. Check availability by postcode."
        canonical="/broadband-plans"
        h1="Broadband plans built for UK homes"
        shortAnswer="OCCTA broadband starts at £34.99/mo with speeds from 74Mbps up to 900Mbps. Every plan includes a free Wi-Fi 6 router, no mid-contract price rises, and a choice of Flex 30 or Price Lock 24 terms where eligible."
        ...
        sections={[
          { heading: "The plans", body: "Essential 74Mbps £34.99, Superfast 150Mbps £37.99, Ultrafast 500Mbps £42.99, Gigabit 900Mbps £46.99 — all inc. VAT, free standard install, free Wi-Fi 6 router." },
        ...
        relatedLinks={[
          ...
          { label: "Router options", to: "/routers", description: "Free router or bring your own." },
