...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to OCCTA – proper British telecom</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Someone's invited you to join{' '}
            <Link href={siteUrl} style={link}><strong>OCCTA</strong></Link>
            . Accept the invitation below and get yourself set up.
          </Text>
