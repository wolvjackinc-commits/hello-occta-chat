...
export function buildJourney2DocumentPack(
  ...
  const product = {
    ...
    estimated_download_mbps: s.product.estimated_download_mbps,
    estimated_upload_mbps: s.product.estimated_upload_mbps,
    speed_statement: s.product.speed_statement,
    router: s.router,
    add_ons: s.addons,
