...
SELECT '8962f90e-b142-4582-b1dc-14d372894691', 'b627a98b-98f2-484c-b5f9-e6e852077aa6', 40.00, 'direct_debit', 'DD-MANUAL-RECONCILE-INV-2607-0004', 'success', '2026-08-15T09:00:00Z', 'Direct Debit collection reported successful by customer on 15 Aug'
-- Fresh replay has no source invoice; preserve this historical correction only where it exists.
WHERE EXISTS (SELECT 1 FROM public.invoices WHERE id = 'b627a98b-98f2-484c-b5f9-e6e852077aa6' AND user_id = '8962f90e-b142-4582-b1dc-14d372894691');
